...
const createCustomShadow = (color: string) => {
  ...
  return {
    ...
    primary: `0 4px 8px 0 ${alpha(PRIMARY.main, 0.24)}`,
    secondary: `0 4px 8px 0 ${alpha(SECONDARY.main, 0.24)}`,
    info: `0 4px 8px 0 ${alpha(INFO.main, 0.24)}`,
    success: `0 4px 8px 0 ${alpha(SUCCESS.main, 0.24)}`,
    warning: `0 4px 8px 0 ${alpha(WARNING.main, 0.24)}`,
    error: `0 4px 8px 0 ${alpha(ERROR.main, 0.24)}`,
  };
};
